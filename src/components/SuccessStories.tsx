...
const SuccessStories: React.FC<SuccessStoriesProps> = ({ setCurrentPage, setSelectedCaseStudy }) => {
  ...
  return (
    <section id="success-stories" className="bg-gray-50 dark:bg-neutral-950 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start mb-24">
          <div className="bg-white dark:bg-white/[0.03] dark:border dark:border-white/[0.06] p-4 rounded-lg shadow-sm">
            <img 

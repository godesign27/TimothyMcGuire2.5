  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-pink-200 via-purple-200 to-indigo-200 dark:from-pink-500/10 dark:via-purple-500/10 dark:to-indigo-500/10"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left max-w-3xl pt-32 pb-20">
            ...
            <p className="text-xl text-gray-700 dark:text-neutral-400">
      ...
      {/* Core Values Section */}
      <section className="py-16 bg-gray-50 dark:bg-white/[0.03] dark:border-t dark:border-b dark:border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-white dark:bg-white/[0.03] dark:border dark:border-white/[0.06] rounded-lg shadow-sm">
              <div className="w-12 h-12 bg-purple-100 dark:bg-purple-500/10 rounded-full flex items-center justify-center mb-4">
                <Brain className="w-6 h-6 text-purple-600 dark:text-purple-400" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Human-Centered Thinking</h3>
              <p className="text-gray-600 dark:text-neutral-400">We prioritize understanding the people behind the screens. By listening, researching, and testing, we design experiences that resonate with real users.</p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-white/[0.03] dark:border dark:border-white/[0.06] rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 dark:text-neutral-400">Great ideas are born from teamwork. We work closely with clients, stakeholders, and developers to craft solutions that align with your vision.</p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-white/[0.03] dark:border dark:border-white/[0.06] rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 dark:text-neutral-400">Good design isn't just about aesthetics—it's about creating results. We measure success by the value we bring to your users and business.</p>
            </div>

            <div className="p-6 bg-white dark:bg-white/[0.03] dark:border dark:border-white/[0.06] rounded-lg shadow-sm">
              <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-500/10 rounded-full flex items-center justify-center mb-4">
                <Sparkles className="w-6 h-6 text-yellow-600 dark:text-yellow-400" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Simplicity with Purpose</h3>
              <p className="text-gray-600 dark:text-neutral-400">We believe in the power of clean, functional design. By focusing on what matters, we create experiences that are easy to navigate and enjoyable to use.</p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-white/[0.03] dark:border dark:border-white/[0.06] rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 dark:text-neutral-400">Design should be for everyone. That's why we follow best practices to ensure our solutions are accessible, inclusive, and welcoming to all users.</p>
            </div>
          </div>

          <div className="mt-16 text-center">
            <p className="text-xl italic text-gray-600 dark:text-neutral-400">
